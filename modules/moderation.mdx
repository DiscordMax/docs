...
|`reason`|No       |Reason for warning the user.|
# Unban
The `/unban` command on Report Bot allows moderators to remove a ban from a previously banned user, giving them the ability to rejoin the server. This is useful for lifting punishments after review, appeals, or accidents.

Get started unbanning members using the `/unban` command
| Options | Required | Description                     |
| --------|----------| ------------------------------------- |
|`user`|Yes       |User you want to unban, can be a User ID or mention.|
|`reason`|No       |Reason for unbanning the user.|
